...
# read from a file (see below) and output in C format
$ xxd -r -p ./data-hex-1024.txt | openssl dgst -sha256 -binary | \
    hexdump -v -e '16/1 "0x%02x, " "\n"'
0xd3, 0x45, 0xdb, 0x9e, 0x3d, 0xe8, 0x85, 0x22, 0x8a, 0xc0, 0x27, 0xe5, 0xea, 0xe1, 0x5b, 0x20,
0x5b, 0x93, 0x59, 0x01, 0x57, 0x60, 0x88, 0x5f, 0x1f, 0x9c, 0xb1, 0x9b, 0xe5, 0xd0, 0xad, 0xb7,
```
SHA256 data file: [data-hex-1024.txt](/openssl/data-hex-1024.txt)
